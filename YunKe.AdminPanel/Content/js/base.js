...
var XPage = {
    ...
    DoPostWithConfirm: function (btn, url, data, confirmMsg, suc_callback, fail_callback) {

        var ff = parent.layer.confirm(confirmMsg, {
            btn: ['确认', '取消'] //按钮
        }, function () {
            var hasBtn = btn !== null;
            if (hasBtn) {
            ...
            parent.layer.close(ff);
            var ii = parent.layer.load();
