function fullAvatarEditor() {
	...
	var file			= '/content/js/plugins/fullavatareditor/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var expressInstall = '/content/js/plugins/fullavatareditor/expressInstall.swf';			//expressInstall.swf的路径
